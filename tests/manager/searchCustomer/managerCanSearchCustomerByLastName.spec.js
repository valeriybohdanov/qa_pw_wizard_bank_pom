...
test('Assert manager can search customer by Last Name', async ({ page }) => {
  ...
  */
  ...
  await customersListPage.searchCustomerLastName(addCustomerPage.lastName)
  await customersListPage.assertCustomerPresentInTableByLastName(addCustomerPage.lastName)
